...
- 💻 Compétences :
  - Front-end : **JavaScript, HTML, CSS, Bootstrap, SCSS, JSON, React, Next.js**
  - Back-end : **Ruby, C#, Java, Jakarta EE, Servlet, Maven, JSP, JSTL, SQL, PostgreSQL, XML, API, Node.js, Express, TypeScript, Astro**
